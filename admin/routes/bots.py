...
from domain.bots import BotCreate, BotConnect, BotConnect2FA
from infrastructure.abstractions.AbstractBotsService import AbstractBotsService
...
async def get_bots(
    ...
    bots_overview = await bots.get_bots()
